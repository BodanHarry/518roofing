                ...
                <div class="col-lg-4">
                    <div class="row g-5">
                        <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <p class="mb-0">We use only the best quality materials for all our roofing projects, ensuring that your roof is strong, durable and long-lasting. We offer a wide range of roofing materials to suit your needs and preferences.</p>
                        </div>
                        <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                            <div class="bg-primary rounded d-flex align-items-center justify-content-center mb-3" style="width: 60px; height: 60px;">
                                <i class="fa fa-award text-white"></i>
                            </div>
                            <h4>Wide coverage area</h4>
                            <p class="mb-0">We provide our roofing services to customers within a 150-mile radius, so you can trust that we'll be there when you need us.</p>
                        </div>
                    </div>
                </div>

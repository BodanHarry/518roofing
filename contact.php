                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action ="mail.php" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" placeholder="Subject" name="subject" style="height: 55px;" value="<?php if(isset($email) && $email != null) echo $email;?>">
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" placeholder="Phone" name="phone" style="height: 55px;">
                            </div>
                            <div class="col-12">

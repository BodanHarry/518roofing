        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="row gx-5">
                        <div style="padding-right: 0px;" class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mt-4">
                                ...
                                <a class="btn btn-primary btn-square me-2" href="https://www.facebook.com/people/518-Best-Roofing/100091424776587/"><i class="fab fa-facebook"></i></a>
                            </div>
                        </div>
                        <div style="padding-right: 0px;" class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            <div class="section-title section-title-sm position-relative pb-3 mb-4">

...
require 'phpmailer/PHPMailerAutoload.php';
    ...
    if(!$mail->send()){
      ...
      $mail->setFrom('wstockcontrol@gmail.com','Marquev');
      $mail->addAddress($email);

      $mail->isHTML(true);
      $mail->Subject='Message sent successfully';
    
      $mail->Body="Thank you for contact us!!! We will answer your message soon from our business email: info@marquevsidingsolucions.com";
